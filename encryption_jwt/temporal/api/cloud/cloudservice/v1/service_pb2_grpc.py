...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in temporal/api/cloud/cloudservice/v1/service_pb2_grpc.py depends on'
...
def add_CloudServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('temporal.api.cloud.cloudservice.v1.CloudService', rpc_method_handlers)
