...
class TestAgentImports:
    ...
    def test_category_agent_imports(self):
        ...
        from openai_agents_expense.ai_agents.category_agent import categorize_expense, create_category_agent
    ...
    def test_decision_orchestration_agent_imports(self):
        ...
        assert callable(make_final_decision)
...
class TestAgentCreation:
    ...
    def test_create_policy_evaluation_agent(self):
        ...
        from openai_agents_expense.ai_agents.policy_evaluation_agent import create_policy_evaluation_agent
    ...
    def test_create_decision_orchestration_agent(self):
        ...
        from openai_agents_expense.ai_agents.decision_orchestration_agent import create_decision_orchestration_agent
...
class TestModelsIntegration:
    ...
    def test_all_model_imports(self):
        ...
        assert isinstance(FinalDecision, type)
...
class TestUIIntegration:
    ...
    def test_ui_imports(self):
        ...
        from openai_agents_expense.ui import main, ExpenseState
        
        assert callable(main)
        assert hasattr(ExpenseState, 'CREATED')
        assert hasattr(ExpenseState, 'APPROVED')
        assert hasattr(ExpenseState, 'REJECTED')
        assert hasattr(ExpenseState, 'COMPLETED')
