...
def test_final_decision_model():
    """Test FinalDecision model"""
    from openai_agents_expense.models import FinalDecision
...
def test_confidence_thresholds():
    ...
    for confidence, threshold, should_escalate in test_cases:
        ...
        assert requires_escalation == should_escalate, \
...
@pytest.mark.parametrize("amount,expected_receipt_required", [
    (Decimal("25.00"), False),
